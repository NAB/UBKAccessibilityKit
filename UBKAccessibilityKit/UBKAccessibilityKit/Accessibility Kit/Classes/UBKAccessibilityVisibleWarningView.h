/*
 File: UBKAccessibilityVisibleWarningView.h
...
//The view added to each ui element when a warning is present on that view
@interface UBKAccessibilityVisibleWarningView : UIView
